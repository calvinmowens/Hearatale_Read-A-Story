...
const TargetQuiz = ({ isQuizVisible, closeQuiz, targetWord, quizzedWord }) => {
    ...
    const submitQuiz = (event) => {
        ...
        if (value == "correct") {
            ...
            //coins = localStorage.coincount;
            incrementCoins(coins + 1);
            //localStorage.coincount = coins;
            if (localStorage.coincount) {
                localStorage.coincount = Number(localStorage.coincount)+1;
              } else {
                localStorage.coincount = 1;
              }
        ...
        <div className="popup">
            <div className="popup-inner">
                <div className="popupContainer quizContainer">
                    <h3 className="coinHolder"><span className="iconM">💰</span><span id="coin">{localStorage.coincount}</span></h3>
                    <form>
